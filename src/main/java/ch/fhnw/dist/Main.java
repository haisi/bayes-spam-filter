...
public class Main {
    ...
    void start() {
        ...
        System.out.println(totalSpamProbability(fileHelper.getFileContent("data/spam-kallibrierung/00040.949a3d300eadb91d8745f1c1dab51133"), finalNumberOfSpamMails, finalNumberOfHamMails));

        System.out.println("\n---------------TOTAL SPAM PROBABILITY FOR HAM MAIL:---------------");
        System.out.println(totalSpamProbability(fileHelper.getFileContent("data/ham-kallibrierung/0001.ea7e79d3153e7469e7a9c3e0af6a357e"), finalNumberOfSpamMails, finalNumberOfHamMails));
    }
